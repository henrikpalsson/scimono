...
public class GroupsTest {
  ...
  public void testUpdateGroupWithEmptyBody() {
    ...
    assertThrows(InvalidInputException.class, () -> groups.updateGroup(userId, null, null));
  }

  @Test
  public void testPatchGroupWithEmptyBody() {
    String userId = String.valueOf(UUID.randomUUID());
    assertThrows(InvalidInputException.class, () -> groups.patchGroup(userId, null, null));
  }
